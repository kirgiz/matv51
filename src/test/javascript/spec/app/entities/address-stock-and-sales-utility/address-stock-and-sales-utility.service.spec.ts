...
describe('Service Tests', () => {
  describe('AddressStockAndSalesUtility Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a AddressStockAndSalesUtility', () => {
        service.create(new AddressStockAndSalesUtility(null)).subscribe(received => {
      ...
      it('should update a AddressStockAndSalesUtility', () => {
        service.update(new AddressStockAndSalesUtility(123)).subscribe(received => {
      ...
      it('should return a AddressStockAndSalesUtility', () => {
      ...
      it('should return a list of AddressStockAndSalesUtility', () => {
        service.query(null).subscribe(received => {
          expect(received.body[0].id).toEqual(123);
        });

        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new AddressStockAndSalesUtility(123)]);
      });

      it('should delete a AddressStockAndSalesUtility', () => {
