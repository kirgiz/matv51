...
describe('Service Tests', () => {
  describe('CivilityStockAndSalesUtility Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CivilityStockAndSalesUtility', () => {
        service.create(new CivilityStockAndSalesUtility(null)).subscribe(received => {
      ...
      it('should update a CivilityStockAndSalesUtility', () => {
        service.update(new CivilityStockAndSalesUtility(123)).subscribe(received => {
      ...
      it('should return a CivilityStockAndSalesUtility', () => {
      ...
      it('should return a list of CivilityStockAndSalesUtility', () => {
        service.query(null).subscribe(received => {
          expect(received.body[0].id).toEqual(123);
        });

        const req = httpMock.expectOne({ method: 'GET' });
        req.flush([new CivilityStockAndSalesUtility(123)]);
      });

      it('should delete a CivilityStockAndSalesUtility', () => {
