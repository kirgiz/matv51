...
export class MaterialStockAndSalesUtilityService {
    ...
    create(material: MaterialStockAndSalesUtility): Observable<MaterialStockAndSalesUtility> {
    ...
    update(material: MaterialStockAndSalesUtility): Observable<MaterialStockAndSalesUtility> {
        const copy = this.convert(material);
    ...
    find(id: number): Observable<MaterialStockAndSalesUtility> {
     ...
     */
    private convertItemFromServer(json: any): MaterialStockAndSalesUtility {
        const entity: MaterialStockAndSalesUtility = Object.assign(new MaterialStockAndSalesUtility(), json);
