...
export class AddressclassificationStockAndSalesUtilityService {
    ...
    create(addressclassification: AddressclassificationStockAndSalesUtility):
        Observable<AddressclassificationStockAndSalesUtility> {
    ...
    find(id: number): Observable<AddressclassificationStockAndSalesUtility> {
     ...
     */
    private convertItemFromServer(json: any): AddressclassificationStockAndSalesUtility {
        const entity: AddressclassificationStockAndSalesUtility = Object.assign(new AddressclassificationStockAndSalesUtility(), json);
        return entity;
    }
