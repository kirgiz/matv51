...
export class ThirdclassificationStockAndSalesUtilityService {
    ...
    create(thirdclassification: ThirdclassificationStockAndSalesUtility):
        Observable<ThirdclassificationStockAndSalesUtility> {
    ...
    find(id: number): Observable<ThirdclassificationStockAndSalesUtility> {
     ...
     */
    private convertItemFromServer(json: any): ThirdclassificationStockAndSalesUtility {
        const entity: ThirdclassificationStockAndSalesUtility = Object.assign(new ThirdclassificationStockAndSalesUtility(), json);
        return entity;
    }
