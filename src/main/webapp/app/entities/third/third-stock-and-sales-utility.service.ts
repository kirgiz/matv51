...
export class ThirdStockAndSalesUtilityService {
    ...
    create(third: ThirdStockAndSalesUtility): Observable<ThirdStockAndSalesUtility> {
    ...
    update(third: ThirdStockAndSalesUtility): Observable<ThirdStockAndSalesUtility> {
        const copy = this.convert(third);
    ...
    find(id: number): Observable<ThirdStockAndSalesUtility> {
     ...
     */
    private convertItemFromServer(json: any): ThirdStockAndSalesUtility {
        const entity: ThirdStockAndSalesUtility = Object.assign(new ThirdStockAndSalesUtility(), json);
        return entity;
    }
