...
export class AddressStockAndSalesUtilityService {
    ...
    create(address: AddressStockAndSalesUtility): Observable<AddressStockAndSalesUtility> {
    ...
    update(address: AddressStockAndSalesUtility): Observable<AddressStockAndSalesUtility> {
        const copy = this.convert(address);
    ...
    find(id: number): Observable<AddressStockAndSalesUtility> {
     ...
     */
    private convertItemFromServer(json: any): AddressStockAndSalesUtility {
        const entity: AddressStockAndSalesUtility = Object.assign(new AddressStockAndSalesUtility(), json);
